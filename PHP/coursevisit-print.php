...
<head>
  ...
  <title>REPORTS | Total Visits Per Course</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class ="row">
    <div class="col-8">
    <h3 class="mb-4 mt-3 text-uppercase">Total Count of Visits Per Course<button class="select btn btn-primary" onClick="window.print()"><a class="nav-link" href="#">Print</a></button></h3>
    </div>
    <div class="col-4">
        <?php
    ...
    <form method="POST" action="coursevisit-print.php" class="form">
