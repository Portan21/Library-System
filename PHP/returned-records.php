...
<nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary shadow">
    ...
    <button class="select btn btn-success mt-2"><a class="nav-link" href="returned-records.php">Returned Books</a></button>
    ...
    <thead>
        ...
        <tbody>
            <?php  
                $result = mysqli_query($conn, "SELECT pt_name, book_name, name, return_date
                FROM patron_acc p
