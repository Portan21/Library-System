...
<head>
  ...
  <title>REPORTS | Total Book Request Approval Of Librarian</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class ="row">
    <div class="col-8">
    <h3 class="mb-4 mt-3 text-uppercase">Total Count of Book Request Approval<button class="select btn btn-primary" onClick="window.print()"><a class="nav-link" href="#">Print</a></button></h3>
    </div>
    <div class="col-4">
        <?php
    ...
    <form method="POST" action="totalborrow-print.php" class="form">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($_POST['filter-type'])) {
            $filterType = $_POST['filter-type'];
            $query = "SELECT count(bb.librarianID) as total, name 
            FROM borrowed_book bb
            INNER JOIN lib_acc lc
            ON bb.librarianID = lc.librarianID";
