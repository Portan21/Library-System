...
<head>
  ...
  <title>REPORTS | Total Available Books</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class ="row">
    <div class="col-8">
    <h3 class="mb-4 mt-3 text-uppercase">Total Available Books<button class="select btn btn-primary" onClick="window.print()"><a class="nav-link" href="#">Print</a></button></h3>
    </div>
    <div class="col-4">
        <?php
        ...
        if ($result->num_rows > 0) {
            echo "<table id='example' class='content-table' style='width:100%'>
                      <thead>
                          ...
                          <th class='px-4 py-2 text-center'>Available Books</th>
                      </tr>
                      </thead>
                      <tbody>";
                while($row = mysqli_fetch_assoc($result)){
